            ...
            <div>
                ...
                <Divider />
                 <div id="container">
                     ...
                     <span className="profilename">Android Police</span><i class="fas fa-check-circle fa-xs" id='verify'></i><span className="Handle">@androidpolice<span className="dot">.</span>2h</span>
                     <i class="fas fa-angle-down" id="caret"></i>
