...
export class Search extends React.Component{
    render(){
        ...
        <MuiThemeProvider>
            ...
            <AppBar showMenuIconButton={false} title="aadhar" titleStyle={{fontFamily:"Segoe UI,Arial,sans-serif",fontWeight:'bold',marginLeft:'175px',fontSize:'27px'}}
      ...
      <FlatButton label="Top" primary={true} style={{position:'absolute',marginTop:'14px',marginLeft:'175px',borderBottom:'2px solid',borderBottomColor:'#5AB2E8'}} labelStyle={{textTransform:'none',color:"#5AB2E8",fontWeight:"bold",fontSize:14,fontFamily:"Segoe UI,Arial,sans-serif"}} hoverColor ="#E8F4FB" />
      <FlatButton label="Latest" disabled={true} style={{position:'absolute',marginTop:'14px',marginLeft:'255px',borderBottom:'2px solid',borderBottomColor:'#FFFFFF'}} labelStyle={{textTransform:'none',color:"#657786",fontWeight:"bold",fontSize:14,fontFamily:"Segoe UI,Arial,sans-serif"}} hoverColor ="#E8F4FB" />
      <FlatButton label="People" disabled={true} style={{position:'absolute',marginTop:'14px',marginLeft:'330px',borderBottom:'2px solid',borderBottomColor:'#FFFFFF'}} labelStyle={{textTransform:'none',color:"#657786",fontWeight:"bold",fontSize:14,fontFamily:"Segoe UI,Arial,sans-serif"}} hoverColor ="#E8F4FB" />
      <FlatButton label="Photos" disabled={true} style={{position:'absolute',marginTop:'14px',marginLeft:'410px',borderBottom:'2px solid',borderBottomColor:'#FFFFFF'}} labelStyle={{textTransform:'none',color:"#657786",fontWeight:"bold",fontSize:14,fontFamily:"Segoe UI,Arial,sans-serif"}} hoverColor ="#E8F4FB" />
      <FlatButton label="Videos" disabled={true} style={{position:'absolute',marginTop:'14px',marginLeft:'490px',borderBottom:'2px solid',borderBottomColor:'#FFFFFF'}} labelStyle={{textTransform:'none',color:"#657786",fontWeight:"bold",fontSize:14,fontFamily:"Segoe UI,Arial,sans-serif"}} hoverColor ="#E8F4FB" />
      <FlatButton label="News" disabled={true} style={{position:'absolute',marginTop:'14px',marginLeft:'570px',borderBottom:'2px solid',borderBottomColor:'#FFFFFF'}} labelStyle={{textTransform:'none',color:"#657786",fontWeight:"bold",fontSize:14,fontFamily:"Segoe UI,Arial,sans-serif"}} hoverColor ="#E8F4FB" />
      <FlatButton label="Broadcasts" disabled={true} style={{position:'absolute',marginTop:'14px',marginLeft:'650px',borderBottom:'2px solid',borderBottomColor:'#FFFFFF'}} labelStyle={{textTransform:'none',color:"#657786",fontWeight:"bold",fontSize:14,fontFamily:"Segoe UI,Arial,sans-serif"}} hoverColor ="#E8F4FB" />
      <IconMenu style={{position:'absolute',marginLeft:'1340px',marginTop:'5px'}}
    ...
    <Paper style={{width:'290px',height:'52px',marginLeft:'200px',marginTop:'175px'}} zDepth={0} rounded={false}>
     <div id="filtercontainer">
            <span className="name">Search filters<span className="dot">.</span><span className="subtext">Show</span></span>
         </div>
     </Paper>
     <Paper style={{width:'290px',height:'186px',marginLeft:'200px',marginTop:'10px'}} zDepth={0} rounded={false}>
     ...
     <span className="subtext" style={{position:'absolute',top:'175px',left:'1040px',fontFamily:"Segoe UI,Arial,sans-serif"}}>View all</span>
     <Paper style={{width:'589.98px', height:'426px',marginLeft:'505px',marginTop:'-965px'}} zDepth={0}>
     ...
     <span className="subtext" style={{position:'absolute',top:'675px',left:'1040px',fontFamily:"Segoe UI,Arial,sans-serif"}}>View all</span>
     <div style={{position:'absolute',left:'505px',top:'700px'}}> 
     <PeopleCard bgimg='aadarjbanner.jpg' profpic='aadarj.jpg' name='Aadar Jain' handle='@AadarJain' description='Actor (work in progress)'/>
     </div>
     <div style={{position:'absolute',left:'805px',top:'700px'}}> 
     ...
     <Paper style={{display:'inline-block',marginLeft: 10,marginRight: 10,position:'absolute',left:'495px',top:'1000px',width:'588px',height:'121px'}} zDepth={0} rounded={false}>
            ...
            <span className="profilename">Rohan.</span><span className="Handle">@rohanchouhan98<span className="dot">.</span>Dec 23</span>
             ...
             <Paper style={{display:'inline-block',marginLeft: 10,marginRight: 10,position:'absolute',left:'495px',top:'1121px',width:'588px',height:'89px'}} zDepth={0} rounded={false}>
            <Divider />
            <div style={{paddingTop:'9px',paddingBottom:'9px',paddingLeft:'12px',paddingRight:'12px'}}>
            ...
            <span className="profilename">Pranav</span><span className="Handle">@prnv_<span className="dot">.</span>Dec 20</span>
             ...
             <Paper style={{display:'inline-block',marginLeft: 10,marginRight: 10,position:'absolute',left:'495px',top:'1210px',width:'588px',height:'514px'}} zDepth={0} rounded={false}>
            <Divider />
            <div style={{paddingTop:'9px',paddingBottom:'9px',paddingLeft:'12px',paddingRight:'12px'}}>
            ...
            <span className="profilename">Vishal yadav</span><span className="Handle">@Yadav_vishal_<span className="dot">.</span>Dec 20</span>
                ...
                <Paper style={{width:'290px',height:'66px',position:'absolute',left:'200px',top:'1185px',backgroundolor:'#e6ecf0'}} zDepth={0} rounded={false}>
                    <div style={{padding:'15px'}}>
